...
if __name__ == "__main__":
    # Define path to the FNIRS_Data directory (one level up)
    sessions_path = os.path.join(os.path.dirname(os.getcwd()), 'FNIRS_Data')
    script_name = os.path.basename(__file__)

    # Get items to encrypt from the /FNIRS_Data folder
